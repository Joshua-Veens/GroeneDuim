(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(t){if(t.ep)return;t.ep=!0;const n=o(t);fetch(t.href,n)}})();document.addEventListener("DOMContentLoaded",()=>{const r=new URLSearchParams(window.location.search).get("id");r?fetch(`/api/plants/${r}`).then(e=>e.json()).then(e=>{document.getElementById("plant-name").textContent=e.scientific_name;const o=`
          ...
          `;document.getElementById("plant-info").innerHTML=o}).catch(e=>{console.error("Error fetching plant data:",e),document.getElementById("plant-info").innerHTML="<p>Error fetching plant data</p>"}):document.getElementById("plant-info").innerHTML="<p>Plant ID not specified in the URL.</p>"});
//# sourceMappingURL=main-wuT5zKVG.js.map
